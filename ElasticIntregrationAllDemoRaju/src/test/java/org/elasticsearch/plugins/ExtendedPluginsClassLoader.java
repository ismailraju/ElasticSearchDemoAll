...
/**
 * A classloader that is a union over the parent core classloader and
 * classloaders of extended plugins. Cloned from ES repository - that file is
 * only available in ES server libs - and we need it o create a node client for
 * unittests
 */
