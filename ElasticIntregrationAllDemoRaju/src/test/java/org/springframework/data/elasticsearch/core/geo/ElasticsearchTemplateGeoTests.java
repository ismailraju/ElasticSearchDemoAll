 ...
 * @author Peter-Josef Meisch Basic info: latitude - horizontal lines (equator =
 * 0.0, values -90.0 to 90.0) longitude - vertical lines (Greenwich = 0.0,
 * values -180 to 180) London [lat,lon] = [51.50985,-0.118082] - geohash =
 * gcpvj3448 Bouding Box for London = (bbox=-0.489,51.28,0.236,51.686) bbox =
 * left,bottom,right,top bbox = min Longitude , min Latitude , max Longitude ,
 * max Latitude
 */
