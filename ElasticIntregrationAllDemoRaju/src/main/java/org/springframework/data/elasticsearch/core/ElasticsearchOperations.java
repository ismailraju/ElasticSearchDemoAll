...
public interface ElasticsearchOperations {
    ...
    /**
     * Execute the multi-search against elasticsearch and return result as
     * {@link List} of {@link Page}
     *
     * @param queries
     * @param clazz
     * @return
    ...
    /**
     * Execute the multi-search against elasticsearch and return result as
     * {@link List} of {@link Page} using custom mapper
     *
     * @param queries
     * @param clazz
     * @return
     ...
     * <p>
     * Returns a {@link CloseableIterator} that wraps an Elasticsearch scroll
     * context that needs to be closed in case of error.
     *
    ...
    /**
     * Executes the given {@link SearchQuery} against elasticsearch and return
     * result as {@link CloseableIterator} using custom mapper.
     * <p>
     * Returns a {@link CloseableIterator} that wraps an Elasticsearch scroll
     * context that needs to be closed in case of error.
     *
