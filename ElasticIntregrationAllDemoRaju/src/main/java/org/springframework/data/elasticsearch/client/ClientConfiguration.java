...
/**
 * Configuration interface exposing common client configuration properties for
...
public interface ClientConfiguration {
    ...
    /**
     * Creates a new {@link ClientConfiguration} instance configured to
     * localhost.
     * <p/>
     *
     * <pre class="code">
     * // "localhost:9200" ClientConfiguration configuration =
    ...
    /**
     * Creates a new {@link ClientConfiguration} instance configured to a single
     * host given {@code hostAndPort}.
     * <p/>
     * For example given the endpoint http://localhost:9200
     *
     * <pre class="code">
     * ClientConfiguration configuration =
     * ClientConfiguration.create("localhost:9200");
     * </pre>
     *
     * @return a new {@link ClientConfigurationBuilder} instance.
     */
    ...
    /**
     * Creates a new {@link ClientConfiguration} instance configured to a single
     * host given {@link InetSocketAddress}.
     * <p/>
     * For example given the endpoint http://localhost:9200
     *
     * <pre class="code">
    ...
    /**
     * Returns the {@link SSLContext} to use. Can be {@link Optional#empty()} if
     * unconfigured.
     *
     * @return the {@link SSLContext} to use. Can be {@link Optional#empty()} if
     * unconfigured.
     */
    ...
    /**
     * Returns the {@link java.time.Duration socket timeout} which is typically
     * applied as SO-timeout/read timeout.
     *
    ...
    interface ClientConfigurationBuilderWithRequiredEndpoint {
        ...
        /**
         * @param hostAndPort the {@literal host} and {@literal port} formatted
         * as String {@literal host:port}.
        ...
        /**
         * @param hostAndPorts the list of {@literal host} and {@literal port}
         * combinations formatted as String {@literal host:port}.
         * @return the {@link MaybeSecureClientConfigurationBuilder}.
         */
        ...
        /**
         * @param endpoints the list of {@literal host} and {@literal port}
         * combinations.
         * @return the {@link MaybeSecureClientConfigurationBuilder}.
         */
    ...
    interface MaybeSecureClientConfigurationBuilder extends TerminalClientConfigurationBuilder {
        ...
        /**
         * Connect via {@literal https} using the given
         * {@link SSLContext}.<br />
         * <strong>NOTE</strong> You need to leave out the protocol in
         * {@link ClientConfigurationBuilderWithRequiredEndpoint#connectedTo(String)}.
         *
    ...
    interface TerminalClientConfigurationBuilder {
        ...
        /**
         * Configure a {@link java.time.Duration socket timeout} which is
         * typically applied as SO-timeout/read timeout.
         *
         * @param timeout the timeout to use. Must not be {@literal null}.
         * @return the {@link TerminalClientConfigurationBuilder}
         * @see java.net.Socket#setSoTimeout(int)
