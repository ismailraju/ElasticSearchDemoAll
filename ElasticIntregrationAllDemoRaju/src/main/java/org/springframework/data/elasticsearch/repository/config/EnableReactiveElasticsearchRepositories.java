...
/**
 * Annotation to activate reactive Elasticsearch repositories. If no base
 * package is configured through either
 * {@link #value()}, {@link #basePackages()} or {@link #basePackageClasses()} it
...
public @interface EnableReactiveElasticsearchRepositories {
     ...
     * instance. Defaults to {@link ReactiveElasticsearchRepositoryFactoryBean}.
     *
     * @return
     */
