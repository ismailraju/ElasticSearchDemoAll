...
class EntityOperations {
    ...
    /**
     * Determine index name and type name from {@link Entity} with {@code index}
     * and {@code type} overrides. Allows using preferred values for index and
     * type if provided, otherwise fall back to index and type defined on entity
     * level.
     *
     * @param entity the entity to determine the index name. Can be
     * {@literal null} if {@code index} and {@literal type} are provided.
     * @param index index name override can be {@literal null}.
     * @param type index type override can be {@literal null}.
     * @return the {@link IndexCoordinates} containing index name and index
     * type.
    ...
    /**
     * Determine index name and type name from
     * {@link ElasticsearchPersistentEntity} with {@code index} and {@code type}
     * overrides. Allows using preferred values for index and type if provided,
     * otherwise fall back to index and type defined on entity level.
     *
    ...
    interface Entity<T> {
        ...
        /**
         * Returns whether the entity is versioned, i.e. if it contains a
         * version property.
         *
         * @return
         */
        ...
        /**
         * Returns the value of the version if the entity has a version
         * property, {@literal null} otherwise.
         *
         * @return
         */
        @Nullable
        ...
        /**
         * Returns the {@link ElasticsearchPersistentEntity} associated with
         * this entity.
         *
         ...
         * {@link ElasticsearchPersistentEntity} is associated with this entity.
         */
    ...
    interface AdaptibleEntity<T> extends Entity<T> {
         ...
         *
         * @return {@literal true} if the entity has a parent that has an
         * {@literal id}.
         */
        boolean hasParent();
        ...
        /**
         * Populates the identifier of the backing entity if it has an
         * identifier property and there's no identifier currently present.
         *
        ...
        /**
         * Initializes the version property of the of the current entity if
         * available.
         *
         ...
         *
         * @return the entity with the version property incremented if
         * available.
         */
        T incrementVersion();

        /**
         * Returns the current version value if the entity has a version
         * property.
         *
         * @return the current version or {@literal null} in case it's
         * uninitialized or the entity doesn't expose a version property.
         */
        @Nullable
        Number getVersion();
    }
