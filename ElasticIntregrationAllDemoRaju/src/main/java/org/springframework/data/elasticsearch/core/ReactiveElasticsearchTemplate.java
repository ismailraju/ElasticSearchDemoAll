...
public class ReactiveElasticsearchTemplate implements ReactiveElasticsearchOperations {
    ...
    /**
     * Set the default {@link RefreshPolicy} to apply when writing to
     * Elasticsearch.
     *
    ...
    /**
     * Set the default {@link IndicesOptions} for
     * {@link SearchRequest search requests}.
     *
    ...
    /**
     * Pre process the write request before it is sent to the server, eg. by
     * setting the {@link WriteRequest#setRefreshPolicy(String) refresh policy}
     * if applicable.
     *
    ...
    /**
     * Customization hook to modify a generated {@link IndexRequest} prior to
     * its execution. Eg. by setting the
     * {@link WriteRequest#setRefreshPolicy(String) refresh policy} if
     * applicable.
     *
     * @param source the source object the {@link IndexRequest} was derived
     * from.
    ...
    /**
     * Customization hook to modify a generated {@link SearchRequest} prior to
     * its execution. Eg. by setting the
    ...
    /**
     * Customization hook to modify a generated {@link DeleteRequest} prior to
     * its execution. Eg. by setting the
     * {@link WriteRequest#setRefreshPolicy(String) refresh policy} if
     * applicable.
     *
     * @param source the source object the {@link DeleteRequest} was derived
     * from. My be {@literal null} if using the {@literal id} directly.
    ...
    /**
     * Customization hook to modify a generated {@link DeleteByQueryRequest}
     ...
     * <br />
     * You know what you're doing here? Well fair enough, go ahead on your own
     * risk.
     *
     ...
     * <br />
     *
     * @param request the already prepared {@link GetRequest} ready to be
     * executed.
     * @return a {@link Mono} emitting the result of the operation.
     */
     ...
     * <br />
     *
     * @param request the already prepared {@link DeleteByQueryRequest} ready to
     * be executed.
     * @return a {@link Mono} emitting the result of the operation.
     */
