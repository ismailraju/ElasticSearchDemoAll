...
public @interface EnableElasticsearchRepositories {
     ...
     * {@link #basePackageClasses()} for a type-safe alternative to text-based
     * package names.
     */
     ...
     * {@link org.springframework.data.repository.query.QueryLookupStrategy} to
     * be used for lookup queries for query methods. Defaults to
    ...
    /**
     * Returns the {@link org.springframework.beans.factory.FactoryBean} class
     * to be used for each repository instance. Defaults to
