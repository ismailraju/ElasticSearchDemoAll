...
public interface ElasticsearchConverter {
     ...
     * {@link org.springframework.data.mapping.context.MappingContext} used by
     * the converter.
     *
    ...
    /**
     * Returns the underlying
     * {@link org.springframework.core.convert.ConversionService} used by the
     * converter.
     *
     * @return never {@literal null}.
     */
    ...
    /**
     * Convert a given {@literal idValue} to its {@link String} representation
     * taking potentially registered
     * {@link org.springframework.core.convert.converter.Converter Converters}
     * into account.
     *
