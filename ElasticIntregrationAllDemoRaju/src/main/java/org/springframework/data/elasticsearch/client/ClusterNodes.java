...
class ClusterNodes implements Streamable<TransportAddress> {
    ...
    /**
     * Creates a new {@link ClusterNodes} by parsing the given source. The
     * expected format is a comma separated list of host-port-combinations
     * separated by a colon: {@code host:port,host:port,…}.
     *
     * @param source must not be {@literal null} or empty.
     * @return
     */
