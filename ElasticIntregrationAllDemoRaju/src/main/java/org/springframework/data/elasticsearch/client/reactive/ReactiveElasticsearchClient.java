...
public interface ReactiveElasticsearchClient {
    ...
    /**
     * Pings the remote Elasticsearch cluster and emits {@literal true} if the
     * ping succeeded, {@literal false} otherwise.
     *
    ...
    /**
     * Execute a {@link GetRequest} against the {@literal get} API to retrieve a
     * document by id.
     *
     * @param consumer never {@literal null}.
     * @see
     * <a href="https://www.elastic.co/guide/en/elasticsearch/reference/current/docs-get.html">Get
     * API on elastic.co</a>
    ...
    /**
     * Execute the given {@link GetRequest} against the {@literal get} API to
    ...
    /**
     * Execute a {@link MultiGetRequest} against the {@literal multi-get} API to
     * retrieve multiple documents by id.
     *
     * @param consumer never {@literal null}.
     * @see
     * <a href="https://www.elastic.co/guide/en/elasticsearch/reference/current/docs-multi-get.html">Multi
    ...
    /**
     * Execute the given {@link MultiGetRequest} against the
     * {@literal multi-get} API to retrieve multiple documents by id.
     *
    ...
    /**
     * Checks for the existence of a document. Emits {@literal true} if it
     * exists, {@literal false} otherwise.
     *
     * @param consumer never {@literal null}.
     * @return the {@link Mono} emitting {@literal true} if it exists,
    ...
    /**
     * Execute an {@link IndexRequest} against the {@literal index} API to index
     * a document.
     *
     * @param consumer never {@literal null}.
     * @see
     * <a href="https://www.elastic.co/guide/en/elasticsearch/reference/current/docs-index.html">Index
     * API on elastic.co</a>
    ...
    /**
     * Execute an {@link UpdateRequest} against the {@literal update} API to
     * alter a document.
     *
     * @param consumer never {@literal null}.
     * @see
     * <a href="https://www.elastic.co/guide/en/elasticsearch/reference/current/docs-update.html">Update
     * API on elastic.co</a>
    ...
    /**
     * Execute the given {@link UpdateRequest} against the {@literal update} API
     * to alter a document.
     *
    ...
    /**
     * Execute a {@link DeleteRequest} against the {@literal delete} API to
     * remove a document.
     *
     * @param consumer never {@literal null}.
     * @see
     * <a href="https://www.elastic.co/guide/en/elasticsearch/reference/current/docs-delete.html">Delete
     * API on elastic.co</a>
    ...
    /**
     * Execute the given {@link DeleteRequest} against the {@literal delete} API
     ...
     * @param consumer never {@literal null}.
     * @see
     * <a href="https://www.elastic.co/guide/en/elasticsearch/reference/current/search-search.html">Search
     * API on elastic.co</a>
    ...
    /**
     * Execute the given {@link SearchRequest} against the {@literal search}
     * API.
     *
    ...
    /**
     * Execute the given {@link SearchRequest} against the
     * {@literal search scroll} API.
     *
     * @param searchRequest must not be {@literal null}.
     * @see
     * <a href="https://www.elastic.co/guide/en/elasticsearch/reference/current/search-request-scroll.html">Search
    ...
    /**
     * Execute the given {@link SearchRequest} against the
     * {@literal search scroll} API. <br />
     * Scroll keeps track of {@link SearchResponse#getScrollId() scrollIds}
     * returned by the server and provides them when requesting more results via
     * {@code _search/scroll}. All bound server resources are freed on
     * completion.
     *
     * @param headers Use {@link HttpHeaders} to provide eg. authentication
     * data. Must not be {@literal null}.
    ...
    /**
     * Execute a {@link DeleteByQueryRequest} against the
     * {@literal delete by query} API.
     *
     * @param consumer never {@literal null}.
     * @see
     * <a href="https://www.elastic.co/guide/en/elasticsearch/reference/current/docs-delete-by-query.html">Delete
     * By Query API on elastic.co</a>
    ...
    /**
     * Compose the actual command/s to run against Elasticsearch using the
     * underlying {@link WebClient connection}.
     * {@link #execute(ReactiveElasticsearchClientCallback) Execute} selects an
     * active server from the available ones and retries operations that fail
     * with a {@link ConnectException} on another node if the previously
     * selected one becomes unavailable.
     *
     * @param callback the {@link ReactiveElasticsearchClientCallback callback}
     * wielding the actual command to run.
     * @return the {@link Mono} emitting the {@link ClientResponse} once
     * subscribed.
     */
     ...
     * <strong>NOTE</strong> the actual implementation might choose to actively
     * check the current cluster state by pinging known nodes.
     *
    ...
    /**
     * Low level callback interface operating upon {@link WebClient} to send
     * commands towards elasticsearch.
     *
     * @author Christoph Strobl
     * @since 3.2
     */
     ...
     *
     * @see
     * <a href="https://www.elastic.co/guide/en/elasticsearch/client/java-rest/master/_indices_apis.html">Indices
     * API</a>.
     * @author Christoph Strobl
     */
    interface Indices {
        ...
        /**
         * Execute the given {@link GetIndexRequest} against the
         * {@literal indices} API.
         *
         * @param consumer never {@literal null}.
         * @return the {@link Mono} emitting {@literal true} if the index
         * exists, {@literal false} otherwise.
         * @see
        ...
        /**
         * Execute the given {@link DeleteIndexRequest} against the
         * {@literal indices} API.
         *
         * @param consumer never {@literal null}.
         * @return a {@link Mono} signalling operation completion or an
         * {@link Mono#error(Throwable) error} if eg. the index does not exist.
         * @see
         * <a href="https://www.elastic.co/guide/en/elasticsearch/reference/current/indices-delete-index.html">
         * Indices Delete API on elastic.co</a>
         */
        ...
        /**
         * Execute the given {@link CreateIndexRequest} against the
         * {@literal indices} API.
         *
         * @param consumer never {@literal null}.
         * @return a {@link Mono} signalling operation completion or an
         * {@link Mono#error(Throwable) error} if eg. the index already exist.
         * @see
         * <a href="https://www.elastic.co/guide/en/elasticsearch/reference/current/indices-create-index.html">
         * Indices Create API on elastic.co</a>
         */
        ...
        /**
         * Execute the given {@link OpenIndexRequest} against the
         * {@literal indices} API.
         *
         * @param consumer never {@literal null}.
         * @return a {@link Mono} signalling operation completion or an
         * {@link Mono#error(Throwable) error} if eg. the index does not exist.
         * @see
         * <a href="https://www.elastic.co/guide/en/elasticsearch/reference/current/indices-open-close.html">
         * Indices Open API on elastic.co</a>
         */
        ...
        /**
         * Execute the given {@link CloseIndexRequest} against the
         * {@literal indices} API.
         *
         * @param consumer never {@literal null}.
         * @return a {@link Mono} signalling operation completion or an
         ...
         * @see
         * <a href="https://www.elastic.co/guide/en/elasticsearch/reference/current/indices-open-close.html">
         * Indices Close API on elastic.co</a>
         */
        ...
        /**
         * Execute the given {@link RefreshRequest} against the
         * {@literal indices} API.
         *
         * @param consumer never {@literal null}.
         * @return a {@link Mono} signalling operation completion or an
         * {@link Mono#error(Throwable) error} if eg. the index does not exist.
         * @see
         * <a href="https://www.elastic.co/guide/en/elasticsearch/reference/current/indices-refresh.html">
         * Indices Refresh API on elastic.co</a>
         */
        ...
        /**
         * Execute the given {@link PutMappingRequest} against the
         * {@literal indices} API.
         *
         * @param consumer never {@literal null}.
         * @return a {@link Mono} signalling operation completion or an
         * {@link Mono#error(Throwable) error} if eg. the index does not exist.
         * @see
         * <a href="https://www.elastic.co/guide/en/elasticsearch/reference/current/indices-put-mapping.html">
         * Indices Put Mapping API on elastic.co</a>
         */
        ...
        /**
         * Execute the given {@link FlushRequest} against the {@literal indices}
         * API.
         *
         * @param consumer never {@literal null}.
         * @return a {@link Mono} signalling operation completion or an
         * {@link Mono#error(Throwable) error} if eg. the index does not exist.
         * @see
         * <a href="https://www.elastic.co/guide/en/elasticsearch/reference/current/indices-flush.html">
