...
/**
 * Utility class for common access to Elasticsearch clients. {@link RestClients}
 * consolidates set up routines for the various drivers into a single place.
 *
...
public final class RestClients {
    ...
    /**
     * Name of whose value can be used to correlate log messages for this
     * request.
     */
