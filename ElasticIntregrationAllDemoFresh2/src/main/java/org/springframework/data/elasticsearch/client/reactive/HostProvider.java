...
/**
 * Infrastructure helper class aware of hosts within the cluster and the health
 * of those allowing easy selection of active ones.
 *
...
public interface HostProvider {
    ...
    /**
     * Create a new {@link HostProvider} best suited for the given
     * {@link WebClientProvider} and number of hosts.
     *
    ...
    /**
     * Lookup an active host in {@link Verification#LAZY lazy} mode utilizing
     * cached {@link ElasticsearchHost}.
     *
     * @return the {@link Mono} emitting the active host or
     * {@link Mono#error(Throwable) an error} if none found.
     */
     ...
     * @return a {@link WebClient} using the the given endpoint as
     * {@literal base url}.
     */
     ...
     *
     * @return the {@link Mono} emitting {@link ClusterInformation} when
     * available.
     */
    Mono<ClusterInformation> clusterInfo();

    /**
     * {@link Verification} allows to influence the lookup strategy for active
     * hosts.
     *
     * @author Christoph Strobl
     * @since 3.2
