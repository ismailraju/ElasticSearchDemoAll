...
public class ElasticsearchCustomConversions extends CustomConversions {
    ...
    /**
     * Creates a new {@link CustomConversions} instance registering the given
     * converters.
     *
    ...
    /**
     * {@link Converter} to read a {@link UUID} from its {@link String}
     * representation.
     */
    @ReadingConverter
    ...
    /**
     * {@link Converter} to write a {@link UUID} to its {@link String}
     * representation.
     */
    @WritingConverter
    ...
    /**
     * {@link Converter} to read a {@link BigDecimal} from a {@link Double}
     * value.
     */
    @ReadingConverter
    ...
    /**
     * {@link Converter} to write a {@link BigDecimal} to a {@link Double}
     * value.
     */
    @WritingConverter
