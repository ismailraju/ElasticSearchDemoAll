...
/**
 * Elasticsearch specific {@link EntityReader} & {@link EntityWriter}
...
public class ElasticsearchEntityMapper implements
    ...
    /**
     * Set the {@link CustomConversions} to be applied during the mapping
     * process. <br />
     * Conversions are registered after
     * {@link #afterPropertiesSet() bean initialization}.
     *
    ...
    /**
     * Set the {@link ElasticsearchTypeMapper} to use for reading / writing type
     * hints.
     *
    ...
    /**
     * Compute the type to use by checking the given entity against the store
     * type;
     *
     * @param entity
     * @param source
    ...
    private Collection<Object> createCollectionForValue(TypeInformation<?> collectionTypeInformation, int size) {
        ...
        Class<?> collectionType = collectionTypeInformation.isAssignableFrom(collectionTypeInformation) //
