 ...
 * {@link org.elasticsearch.client.RequestConverters} and
 * {@link org.elasticsearch.client.IndicesRequestConverters} by
 * {@literal Elasticsearch}
 * (<a href="https://www.elastic.co">https://www.elastic.co</a>) licensed under
...
public class RequestConverters {
    ...
    /**
     * Utility class to help with common parameter names and patterns. Wraps a
     * {@link Request} and adds the parameters to it directly.
     */
    static class Params {
    ...
    /**
     * Ensure that the {@link IndexRequest}'s content type is supported by the
     * Bulk API and that it conforms to the current {@link BulkRequest}'s
     * content type (if it's known at the time of this method get called).
     *
