...
public abstract class AbstractReactiveElasticsearchConfiguration extends ElasticsearchConfigurationSupport {
    ...
    /**
     * Return the {@link ReactiveElasticsearchClient} instance used to connect
     * to the cluster. <br />
     * Annotate with {@link Bean} in case you want to expose a
     * {@link ReactiveElasticsearchClient} instance to the
    ...
    /**
     * Set up the write {@link RefreshPolicy}. Default is set to
     * {@link RefreshPolicy#IMMEDIATE}.
     *
    ...
    /**
     * Set up the read {@link IndicesOptions}. Default is set to
     * {@link IndicesOptions#strictExpandOpenAndForbidClosed()}.
     *
     * @return {@literal null} to use the server defaults.
     */
    @Nullable
