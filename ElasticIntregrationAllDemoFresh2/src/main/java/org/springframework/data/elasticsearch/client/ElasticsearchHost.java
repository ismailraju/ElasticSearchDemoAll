...
public class ElasticsearchHost {
     ...
     *
     * @param hostAndPort the string containing host and port or IP address and
     * port in the format {@code host:port}.
    ...
    /**
     * @return {@literal true} if the last known {@link State} was
     * {@link State#ONLINE}
     */
