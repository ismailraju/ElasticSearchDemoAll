...
public interface ResultsMapper extends SearchResultMapper, GetResultMapper, MultiGetResultMapper {
     ...
     * <strong>NOTE</strong> Should be overwritten in implementation to make use
     * of the type cache.
     *
     * @since 3.2
     */
     ...
     * @param <T>
     * @return can be {@literal null} if the
     * {@link GetResult#isSourceEmpty() is empty}.
     * @since 3.2
     */
    @Nullable
     ...
     * @param type must not be {@literal null}.
     * @param <T>
     * @return can be {@literal null} if the {@link SearchHit} does not have
     * {@link SearchHit#hasSource() a source}.
     * @since 3.2
     */
    @Nullable
