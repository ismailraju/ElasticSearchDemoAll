...
public interface ReactiveElasticsearchQueryExecution {
    ...
    /**
     * An {@link ReactiveElasticsearchQueryExecution} that wraps the results of
     * the given delegate with the given result processing.
     */
    @RequiredArgsConstructor
    final class ResultProcessingExecution implements ReactiveElasticsearchQueryExecution {

        private final @NonNull
        ReactiveElasticsearchQueryExecution delegate;
        private final @NonNull
    ...
    /**
     * A {@link Converter} to post-process all source objects using the given
