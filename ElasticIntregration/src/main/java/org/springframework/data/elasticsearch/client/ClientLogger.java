...
/**
 * Logging Utility to log client requests and responses. Logs client requests
 * and responses to Elasticsearch to a dedicated logger:
 * {@code org.springframework.data.elasticsearch.client.WIRE} on
 * {@link org.slf4j.event.Level#TRACE} level.
 *
 * @author Mark Paluch
...
public abstract class ClientLogger {
    ...
    /**
     * Creates a new, unique correlation Id to improve tracing across log
     * events.
     *
