...
/**
 * Utility to parse endpoints in {@code host:port} format into
...
class InetSocketAddressParser {
     ...
     *
     * @param hostPortString Hostname/IP address and port formatted as
     * {@code host:port} or {@code host}.
     * @param defaultPort default port to apply if {@code hostPostString} does
     * not contain a port.
     * @return a {@link InetSocketAddress} that is unresolved to avoid DNS
     * lookups.
     ...
     * parsing fails.
     *
     * @param hostPortString the full bracketed host-port specification. Post
     * might not be specified.
     * @return an array with 2 strings: host and port, in that order.
     * @throws IllegalArgumentException if parsing the bracketed host-port
     * string fails.
     */
