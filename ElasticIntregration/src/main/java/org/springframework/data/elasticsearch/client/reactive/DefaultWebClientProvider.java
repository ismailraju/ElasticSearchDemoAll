...
/**
 * Default {@link WebClientProvider} that uses cached {@link WebClient}
 * instances per {@code hostAndPort}.
 *
 * @author Mark Paluch
...
class DefaultWebClientProvider implements WebClientProvider {
    ...
    /**
     * Create new {@link DefaultWebClientProvider} with empty
     * {@link HttpHeaders} and no-op {@literal error listener}.
     *
