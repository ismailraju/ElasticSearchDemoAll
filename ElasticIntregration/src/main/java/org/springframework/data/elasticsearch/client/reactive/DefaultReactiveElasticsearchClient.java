...
/**
 * A {@link WebClient} based {@link ReactiveElasticsearchClient} that connects
 * to an Elasticsearch cluster using HTTP.
 *
...
public class DefaultReactiveElasticsearchClient implements ReactiveElasticsearchClient, Indices {
    ...
    /**
     * Create a new {@link DefaultReactiveElasticsearchClient} using the given
     * {@link HostProvider} to obtain server connections.
     *
    ...
    /**
     * Create a new {@link DefaultReactiveElasticsearchClient} aware of the
     * given nodes in the cluster. <br />
     * <strong>NOTE</strong> If the cluster requires authentication be sure to
     * provide the according {@link HttpHeaders} correctly.
     *
    ...
    /**
     * Create a new {@link DefaultReactiveElasticsearchClient} given
     * {@link ClientConfiguration}. <br />
     * <strong>NOTE</strong> If the cluster requires authentication be sure to
     * provide the according {@link HttpHeaders} correctly.
     *
     * @param clientConfiguration Client configuration. Must not be
     * {@literal null}.
     * @return new instance of {@link DefaultReactiveElasticsearchClient}.
     */
    ...
    /**
     * Reactive client {@link ReactiveElasticsearchClient.Status}
     * implementation.
     *
     * @author Christoph Strobl
     */
    ...
    /**
     * Mutable state object holding scrollId to be used for
     * {@link SearchScrollRequest#scroll(Scroll)}
     *
     * @author Christoph Strobl
     * @since 3.2
     */
