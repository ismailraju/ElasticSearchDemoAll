...
public class Criteria {
     ...
     *
     * @param location
     * {@link org.springframework.data.elasticsearch.core.geo.GeoPoint} center
     * coordinates
     * @param distance {@link String} radius as a string (e.g. : '100km').
     * Distance unit : either mi/miles or km can be set
     * @return Criteria the chaind criteria with the new 'within' criteria
     * included.
     */
     ...
     * Creates new CriteriaEntry for {@code location WITHIN distance}
     *
     * @param location {@link org.springframework.data.geo.Point} center
     * coordinates
     ...
     *
     * @param geoLocation {@link String} center point supported formats: lat on
     * = > "41.2,45.1", geohash = > "asd9as0d"
     * @param distance {@link String} radius as a string (e.g. : '100km').
     * Distance unit : either mi/miles or km can be set
     * @return
     */
     ...
     *
     * @param boundingBox
     * {@link org.springframework.data.elasticsearch.core.geo.GeoBox} bounding
     * box(left top corner + right bottom corner)
     * @return Criteria the chaind criteria with the new 'boundingBox' criteria
     * included.
     */
     ...
     * @return Criteria the chaind criteria with the new 'boundedBy' criteria
     * included.
     */
